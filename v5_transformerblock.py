...
now the block basically interspreses
communicatoin and then computation

the communication is done using multiheaded self-attention

the computatoin is done using hte feed foward Network
