"""
the second innovation that is very helpful
for optimizing deep neural networks is right here

Norm - LayerNorm

LayerNorm is implemented in PyTorch
it's a paper "Layer Normalization" that came out in 2016

LayerNorm is very very similar to batchNorm
batch normalization basically just makes sure that
across the batch dimension
any individual neuron had unit 
gaussian distribution
so it was zero mean unit standard deviation
one standard deviation output
"""

'''
basically we need two layer Norms
 '''
import torch
